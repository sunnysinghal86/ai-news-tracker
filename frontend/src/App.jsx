    ...
    <div style={{ background: T.paper, minHeight: "100vh", color: T.ink }}>
      ...
      <main style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 32px 80px" }}>
        ...
        {activeTab === "feed" && (
          <>
            {/* Filter strip */}
            {/* Filter strip — single row, evenly spread */}
            <div style={{ display: "flex", alignItems: "center", padding: "14px 0", borderBottom: `1px solid ${T.rule}`, gap: "24px" }}>
              ...
              <label style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "11px", color: T.muted, fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: "0.08em", whiteSpace: "nowrap", flexShrink: 0 }}>
                ...
                <input type="range" min={0} max={9} value={filters.min_relevance}
                  ...
                  style={{ width: "90px", accentColor: T.ink }} />
